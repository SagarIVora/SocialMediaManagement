...
{
    [NopMigration("2020/02/03 11:24:16:2551771", "Nop.Data base schema", MigrationProcessType.Installation)]
    public class SchemaMigration : AutoReversingMigration
    {
        ...
        public override void Up()
        {
            ...
            Create.TableFor<UserEmailOtp>();
            Create.TableFor<UserMobileOTP>();
        }
    }
}
